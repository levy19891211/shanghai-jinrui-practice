...
- [x] `[WB]` 真题录入:TMUA Specimen 2017 Paper 1(20 题)+ Paper 2(17 题),共 37 道官方真题入库(题库 44)
- [ ] `[WB]` 图形题补录:Paper 2 Q4(卡片反例)、Q7/Q10(函数图形)为图片题,待前端支持图片选项后补充
- [ ] `[WB]` 批量导入 API(Excel / CSV / JSON)
- [ ] `[WB]` 组卷功能(按知识点/难度/数量生成试卷)
- [ ] `[VC]` 导入与组卷界面
- [ ] `[WB]` 2016-2023 正卷录入(需 OCR 或人工,公式校对成本高,建议优先用真题批量导入)
